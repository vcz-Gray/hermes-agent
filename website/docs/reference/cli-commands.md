...
| `hermes sync` | Sync the current Hermes fork branch from `upstream`, rebase it, and push it to `origin`. Intended for fork-based operator workflows before `hermes update`. |
